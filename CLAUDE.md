...
- service `Neo4j Graph Database (Metal-Ready)`: `fca5eba2-01fb-420f-8188-bb184e16e199` — **queued for teardown** (2026-05-25). All code paths reading from / writing to Neo4j were removed; the world-model graph is now Graphiti+FalkorDB only. Safe to delete the Railway service + unset `NEO4J_URI`/`NEO4J_USER`/`NEO4J_PASSWORD` on the api-server.
