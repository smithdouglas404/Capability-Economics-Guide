...
import { Briefcase, Shield, Users, Network, Building2, Layers, Lightbulb, Activity, ScanSearch, Settings2, Sparkles, Zap, Inbox, CreditCard, DollarSign, FlaskConical, Swords, Target, Rocket, Bell, BarChart3, PieChart, MessageSquare, Scale, MessageCircle } from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: "/trade-signals", label: "Signals", icon: Target },
    { href: "/innovation", label: "Pipeline", icon: Rocket },
    { href: "/watchlist", label: "Watchlist", icon: Bell },
    { href: "/benchmarking", label: "Peers", icon: BarChart3 },
    { href: "/roi", label: "ROI", icon: PieChart },
    { href: "/ask", label: "Ask", icon: MessageSquare },
    { href: "/regulations", label: "Compliance", icon: Scale },
    { href: "/collaborate", label: "Collab", icon: MessageCircle },
