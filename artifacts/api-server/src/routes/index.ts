...
import adminDisruptionIndexRouter from "./admin-disruption-index";
import adminGraphitiCountsRouter from "./admin-graphiti-counts";
import adminGraphitiAlgorithmsRouter from "./admin-graphiti-algorithms";
import adminGraphitiVectorRouter from "./admin-graphiti-vector";
import adminTunablesRouter from "./admin-tunables";
import adminGraphitiChokepointsRouter from "./admin-graphiti-chokepoints";
import capabilityGraphInsightsRouter from "./capability-graph-insights";
import adminStuckRunsRouter from "./admin-stuck-runs";
import adminRecoverMessagesRouter from "./admin-recover-messages";
import adminSeedHospitalityTransportRouter from "./admin-seed-hospitality-transport";
import disruptionSimulatorRouter from "./disruption-simulator";
...
router.use(adminDisruptionIndexRouter);
router.use(adminGraphitiCountsRouter);
router.use(adminGraphitiAlgorithmsRouter);
router.use(adminGraphitiVectorRouter);
router.use(adminTunablesRouter);
router.use(adminGraphitiChokepointsRouter);
router.use(capabilityGraphInsightsRouter);
router.use(adminStuckRunsRouter);
router.use(adminRecoverMessagesRouter);
router.use(adminSeedHospitalityTransportRouter);
router.use(disruptionSimulatorRouter);
