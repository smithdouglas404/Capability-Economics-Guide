...
const SERVICE_DESCRIPTIONS: Record<string, string> = {
  ...
  agent_stack_optimizer: "Daily recommender — reads disruption + peer-coop digests + FalkorDB graph signals + Mem0 patterns, produces investment-priority recommendations. Haiku 4.5 + AgentKit.",
  agent_ontology: "Entity-extraction agent — runs every 4h after others publish, writes :Entity nodes to the FalkorDB world-model graph via Graphiti MCP. Haiku 4.5 + AgentKit.",
